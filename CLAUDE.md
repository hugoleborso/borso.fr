...
- **No slang, no abbreviations, no offhand verbs.** Relaxed but professional, between peers. In French, tutoiement is fine — but write full words and a careful register: *distribution* not *distrib*, *modifies / supprimes / retires* not *touches*, never *truc* / *machin*. The voice is a peer who writes precisely, not someone speaking casually.
