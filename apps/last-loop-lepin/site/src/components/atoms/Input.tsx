...
/**
 * Tailwind's preflight strips the file picker's native button chrome, which
 * would otherwise leave "Choose file" as bare text, so the button is drawn
 * here in the application's own palette.
 */
