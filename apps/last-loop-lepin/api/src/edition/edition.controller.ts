...
editionRouter.get('/:slug', async (context) => {
  try {
...
editionRouter.get('/:slug/state', async (context) => {
...
adminEditionRouter.use('*', requireAdminSession);

adminEditionRouter.post(
  '/',
