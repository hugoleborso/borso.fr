...
| `infra/cdk/src/internal/migration-runner/index.ts` | 16 | unknown | the path does not say what the file is | 16 |
...
| `infra/shared/bin/shared.ts` | 10 | unknown | the path does not say what the file is | 10 |
