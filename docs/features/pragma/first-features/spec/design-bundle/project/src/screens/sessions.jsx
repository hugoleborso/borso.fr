      ...
      <div className="ph">
        <div>
          ...
          <div className="ph-sub">
            2 concerts à venir · 3 répétitions planifiées · prochain rendez-vous lundi 8 septembre
          </div>
        </div>
...
const Stat = ({ label, v, sub }) => (
  ...
  >
    ...
    <span style={{ fontSize: 10.5, color: 'var(--ink-400)', minWidth: 80, textAlign: 'right' }}>
      {sub}
    </span>
  </div>
);
  ...
  return (
    <div className="card" style={{ cursor: 'pointer', padding: 14 }} onClick={onOpen}>
      ...
      {isConcert ? (
        ...
        >
          Répétition · prépare{' '}
          {session.preparedConcertId === 'c01' ? 'Les Disquaires' : "L'Alimentation Générale"}
        </div>
      )}
    </div>
  );
    ...
    <div className="page">
      ...
      <div className="ph">
        ...
        <div className="ph-actions">
          ...
          <button className="btn primary" onClick={onOpenSetlist}>
          ...
          <div className="card">
            ...
            >
              ...
              <span style={{ fontFamily: 'var(--t-mono)' }}>
                {Math.round((totalFriends / session.capacity) * 100)}% · {totalFriends}/
                {session.capacity}
              </span>
            </div>
          </div>
        ...
        <aside className="col" style={{ gap: 16 }}>
          ...
          <div className="card flat" style={{ background: 'var(--bg-sunk)', border: 'none' }}>
            ...
            <div style={{ fontSize: 12.5, lineHeight: 1.5 }}>
              Gui rappelle pour la balance vendredi. On arrive 1h avant pour l'install. Pensez à
              amener des t-shirts noirs.
            </div>
          </div>
        </aside>
      </div>
...
const PrepRow = ({ label, date, done, highlight }) => (
  ...
  >
    ...
    <span style={{ fontFamily: 'var(--t-mono)', fontSize: 11, color: 'var(--ink-500)' }}>
      {date}
    </span>
  </div>
);
        ...
        <div className="card">
          ...
          <div className="col" style={{ gap: 10 }}>
            <PracticeBlock
              title="Échauffement"
              dur="15 min"
              body="Gammes — fa majeur, sol majeur. Tempo 90."
            />
            <PracticeBlock
              title="Bloc 1 — nouveautés"
              dur="45 min"
              body="Maniac (refrain), Assassymphonie (intro)."
            />
            <PracticeBlock title="Pause" dur="10 min" body="" />
            <PracticeBlock
              title="Bloc 2 — setlist filée"
              dur="60 min"
              body="Setlist concert dans l'ordre, sans s'arrêter."
            />
...
const PracticeBlock = ({ title, dur, body }) => (
  <div
    style={{ display: 'flex', gap: 14, padding: '12px 0', borderBottom: '1px dashed var(--line)' }}
  >
    <div
      style={{
        flex: '0 0 80px',
