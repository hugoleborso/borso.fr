    ...
    <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
      ...
      >
        ...
        <span className="tag-mono">
          Σ {Object.keys(m).length}×{instruments.length}
        </span>
      </div>
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          fontSize: 10.5,
          color: v ? 'var(--ink-700)' : 'var(--ink-300)',
          minWidth: 18,
          textAlign: 'right',
        }}
      >
      ...
      <div className="ph">
        <div>
          ...
          <div className="ph-sub">
            {members.length} membres · chaque membre peut jouer chaque instrument, à des niveaux
            différents
          </div>
        </div>
            ...
            <table className="tbl">
              ...
              <tbody>
                {members.map((m) => {
                  ...
                  const top = Object.entries(row).sort(([, a], [, b]) => b - a)[0];
                    ...
                    <tr key={m.id}>
                      ...
                      <td>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                          ...
                          <span
                            className="mono"
                            style={{ fontSize: 11, color: 'var(--ink-500)', minWidth: 28 }}
                          >
                            {avg.toFixed(1)}
                          </span>
                        </div>
          ...
          <aside className="col" style={{ gap: 14 }}>
                ...
                {['chip', 'pill', 'accent', 'avatar'].map((s) => (
                  <button
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      border:
                        memberStyle === s ? '1.5px solid var(--ink-700)' : '1px solid var(--line)',
                      borderRadius: 8,
                      padding: '10px 12px',
            ...
            <div className="card flat" style={{ background: 'var(--bg-sunk)', border: 'none' }}>
              ...
              <div style={{ fontSize: 12.5, lineHeight: 1.45 }}>
                La maîtrise moyenne d'un morceau est la moyenne des cellules de la matrice pour le
                lineup choisi. Visible sur chaque fiche morceau et dans la setlist.
              </div>
            </div>
          </aside>
        </div>
  ...
  <div className="page">
    ...
    <div className="ph">
      <div>
        <h1>Instruments</h1>
        <div className="ph-sub">
          Les instruments harmoniques déclenchent l'algorithme d'avertissement de transition.
        </div>
      </div>
      <div className="ph-actions">
        <button className="btn accent">
    ...
    <div className="card" style={{ padding: 0, overflow: 'hidden', maxWidth: 540 }}>
      <table className="tbl">
        ...
        <tbody>
          {instruments.map((i) => (
            <tr key={i.id}>
              <td style={{ fontFamily: 'var(--t-display)', fontStyle: 'italic', fontSize: 17 }}>
                {i.name}
              </td>
              <td>
                <span
  ...
  return (
    <div
      style={{
        ...
        backgroundImage:
          'radial-gradient(circle at 30% 20%, rgba(196,88,58,0.06), transparent 50%), radial-gradient(circle at 80% 90%, rgba(61,138,138,0.05), transparent 50%)',
      }}
    >
      <form
        onSubmit={submit}
