...
window.PragmaData = (() => {
  ...
  const SONGS = [
    ...
    {
      id: 's13',
      title: 'Killing Me Softly / Mourir sur scène',
      artist: 'Medley',
      status: 'wip',
      tonalityStart: 'Am',
      tonalityEnd: 'Cm',
  ...
  const SESSIONS = [
    {
      ...
      capacity: 80,
      gear: 'Sono maison, retours x4',
      friends: { hugo: 12, gui: 4, arn: 8, cosyn: 2, emma: 6 },
      status: 'upcoming',
    },
    {
      id: 'c02',
      kind: 'concert',
      date: '2025-09-27',
      venue: 'L’Alimentation Générale',
      capacity: 120,
      gear: 'Apporter ampli basse',
      friends: {},
      status: 'upcoming',
    },
    ...
    { id: 'p05', kind: 'practice', date: '2025-09-22', preparedConcertId: 'c02' },
    {
      ...
      kind: 'concert',
      date: '2025-06-21',
      venue: 'Fête de la musique — Bastille',
      capacity: 200,
      gear: '—',
      friends: { hugo: 25, gui: 12, arn: 14, cosyn: 8, emma: 18 },
      status: 'past',
    },
  ];
  ...
  const BARS = [
    {
      ...
      status: 'booked',
      last: '2025-08-22',
      notes: 'Confirmé pour le 13/09 — Gui rappelle pour la balance.',
      contact: 'Gui',
    },
    {
      id: 'b02',
      ...
      status: 'booked',
      last: '2025-08-30',
      notes: 'Confirmé 27/09. Demandent une affiche au format A3 deux semaines avant.',
      contact: 'Gui',
    },
    {
      id: 'b03',
      ...
      status: 'contacted',
      last: '2025-08-15',
      notes: 'Mail envoyé à Marie pour novembre. Relance prévue.',
      contact: 'Hugo',
    },
    {
      id: 'b04',
      ...
      status: 'contacted',
      last: '2025-08-02',
      notes: 'Réponse positive, attend les dates.',
      contact: 'Hugo',
    },
    {
      id: 'b05',
      ...
      status: 'lead',
      last: '2025-07-04',
      notes: 'Vu en concert — demander la programmation à Thomas.',
      contact: 'Emma',
    },
    {
      id: 'b06',
      ...
      status: 'lead',
      last: null,
      notes: 'Suggéré par Arn. Très bonne sono.',
      contact: 'Arn',
    },
    {
      id: 'b07',
      ...
      status: 'played',
      last: '2025-03-14',
      notes: 'Soirée hyper bien passée — recontacter pour décembre.',
      contact: 'Hugo',
    },
    {
      id: 'b08',
      ...
      status: 'played',
      last: '2025-05-09',
      notes: 'Bonne capa, mais loge minuscule.',
      contact: 'Cosyn',
    },
    {
      id: 'b09',
      name: 'Le Bus Palladium',
      status: 'cold',
      last: '2025-01-22',
      notes: 'Pas de réponse, trop premium pour notre niveau actuel.',
      contact: 'Hugo',
    },
    {
      id: 'b10',
      ...
      status: 'cold',
      last: '2024-11-30',
      notes: 'Refus pour dimensions du backline.',
      contact: 'Hugo',
    },
  ];
