...
- [17:40] `main` a new table added to database-utils' truncate list but not to setup-postgres' TRACKED_TABLES passes the first back-e2e run and fails the second with 42P07, because the harness drops only tracked tables before replaying migrations
