...
- [x] **Developer** — fichiers listés sous _Changes / Files_, port React → vanilla nommé. Pas de toolchain ajoutée (`apps/borso-fr` reste plain HTML/CSS/JS servi par `python3 -m http.server`).
